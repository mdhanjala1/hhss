...
// WhatsApp floating button — ডান দিকে
function WhatsAppButton() {
  return (
    <a
      href={`https://wa.me/${WA}?text=শিল্পশপ থেকে সাহায্য দরকার`}
      target="_blank" rel="noopener noreferrer"
      title="WhatsApp-এ যোগাযোগ করুন"
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2.5 px-4 py-3 rounded-2xl font-bold shadow-2xl transition-all hover:scale-105"
      style={{
