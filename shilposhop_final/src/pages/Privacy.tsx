    ...
    <div className="min-h-screen bg-stone-50 pt-24 pb-16">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white rounded-3xl border border-stone-100 shadow-sm p-10">
          <span className="inline-block px-4 py-1.5 bg-blue-100 text-blue-700 rounded-full text-xs font-bold uppercase tracking-widest mb-4">আইনি</span>
          <h1 className="text-3xl font-bold text-stone-900 mb-8">গোপনীয়তা নীতি</h1>
          {[
